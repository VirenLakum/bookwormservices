...
export class RegisterComponent implements OnInit {
  ...
  constructor(private calendar: NgbCalendar, private userServices:UserServicesService, private dateFormatter:NgbDateParserFormatter) { 
  ...
  registerUser()
  {
    this.userServices.saveregistration(this.user).subscribe((data)=>{ console.log(data) });
  }
